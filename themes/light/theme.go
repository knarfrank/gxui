...
func CreateTheme(driver gxui.Driver) gxui.Theme {
	...
	return &Theme{
		...
		BubbleOverlayStyle:        CreateStyle(gxui.Gray40, gxui.Gray20, gxui.Gray40, 1.0),
		ButtonDefaultStyle:        CreateStyle(gxui.Gray40, gxui.White, gxui.Gray40, 1.0),
		ButtonOverStyle:           CreateStyle(gxui.Gray40, gxui.Gray90, gxui.Gray40, 1.0),
		ButtonPressedStyle:        CreateStyle(gxui.Gray20, gxui.Gray70, gxui.Gray30, 1.0),
		CodeSuggestionListStyle:   CreateStyle(gxui.Gray40, gxui.Gray20, gxui.Gray10, 1.0),
		DropDownListDefaultStyle:  CreateStyle(gxui.Gray40, gxui.White, gxui.Gray20, 1.0),
		DropDownListOverStyle:     CreateStyle(gxui.Gray40, gxui.Gray90, gxui.Gray50, 1.0),
		FocusedStyle:              CreateStyle(gxui.Gray20, gxui.Transparent, focus, 1.0),
		HighlightStyle:            CreateStyle(gxui.Gray40, gxui.Transparent, neonBlue, 2.0),
		LabelStyle:                CreateStyle(gxui.Gray40, gxui.Transparent, gxui.Transparent, 0.0),
		PanelBackgroundStyle:      CreateStyle(gxui.Gray40, gxui.White, gxui.Gray15, 1.0),
		ScrollBarBarDefaultStyle:  CreateStyle(gxui.Gray40, gxui.Gray30, gxui.Gray40, 1.0),
		ScrollBarBarOverStyle:     CreateStyle(gxui.Gray40, gxui.Gray50, gxui.Gray60, 1.0),
		ScrollBarRailDefaultStyle: CreateStyle(gxui.Gray40, scrollBarRailDefaultBg, gxui.Transparent, 1.0),
		ScrollBarRailOverStyle:    CreateStyle(gxui.Gray40, scrollBarRailOverBg, gxui.Gray20, 1.0),
		SplitterBarDefaultStyle:   CreateStyle(gxui.Gray40, gxui.Gray80, gxui.Gray40, 1.0),
		SplitterBarOverStyle:      CreateStyle(gxui.Gray40, gxui.Gray80, gxui.Gray50, 1.0),
		TabActiveHighlightStyle:   CreateStyle(gxui.Gray30, neonBlue, neonBlue, 0.0),
		TabDefaultStyle:           CreateStyle(gxui.Gray40, gxui.White, gxui.Gray40, 1.0),
		TabOverStyle:              CreateStyle(gxui.Gray30, gxui.Gray90, gxui.Gray50, 1.0),
		TabPressedStyle:           CreateStyle(gxui.Gray20, gxui.Gray70, gxui.Gray30, 1.0),
		TextBoxDefaultStyle:       CreateStyle(gxui.Gray40, gxui.White, gxui.Gray20, 1.0),
		TextBoxOverStyle:          CreateStyle(gxui.Gray40, gxui.White, gxui.Gray50, 1.0),
	}
}
